      ...
      <div className={styles._containar}>
        <div className={styles._upper_div}>
          <fieldset className={styles.fieldset_div}>
            <legend className={styles.lagend}>
              <span className={styles.pipe}>\</span> Sell Your Car on PakWheels
              and Get the Best Price <span className={styles.pipe}>/</span>
            </legend>

            <div className={styles.first}>
              <h1 className={styles._headings_h1}>Post your Ad on PakWheels</h1>
              <div className={styles._perass_div}>
                <p className={styles._perass}>
                  <span className="text-green-500">✔</span> Post your Ad for
                  Free in 3 Easy Steps
                </p>
                <p className={styles._perass}>
                  <span className="text-green-500">✔</span> Get Genuine offers
                  from Verified Buyers
                </p>
                <p className={styles._perass}>
                  <span className="text-green-500">✔</span> Sell your car Fast
                  at the Best Price
                </p>
            ...
            <div className={styles.center}>
              {" "}
              <legend className={styles.lagend_center}>OR</legend>
            </div>

            <div className={styles.second}>
              <h1 className={styles._headings_h1}>
                Try PakWheels Sell It For Me
              </h1>
              <div className={styles._perass_div}>
                <p className={styles._perass}>
                  <span className="text-green-500">✔</span> Dedicated Sales
                  Expert to Sell your Car
                </p>
                <p className={styles._perass}>
                  <span className="text-green-500">✔</span> We Bargain for you
                  and share the Best Offer
                </p>
                <p className={styles._perass}>
                  <span className="text-green-500">✔</span> We ensure Safe &
                  Secure Transaction
                </p>
