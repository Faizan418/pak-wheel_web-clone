        ...
        <div className={styles._main_box}>
          <Link href={"#"}>
            <div className={styles.main_div}>
              ...
              <div className={styles.desc_div}>
                <h1 className={styles.box_heading_blue}>PakWheels</h1>
                <p className="text-sm">SELL IT FOR ME</p>
              </div>
            </div>
          </Link>
          ...
          <Link href={"#"}>
            <div className={styles.main_div}>
              ...
              <div className={styles.desc_div}>
                <h1 className={styles.box_heading_blue}>PakWheels</h1>
                <p className="text-sm">AUCTION SHEET VERIFICATION</p>
              </div>
            </div>
          </Link>
          ...
          <Link href={"#"}>
            <div className={styles.main_div}>
              ...
              <div className={styles.desc_div}>
                <h1 className={styles.box_heading_blue}>PakWheels</h1>
                <p className="text-sm">CAR INSPECTION</p>
              </div>
            </div>
          </Link>
          ...
          <Link href={"#"}>
            <div className={styles.main_div}>
              ...
              <div className={styles.desc_div}>
                <h1 className={styles.box_heading_blue}>PakWheels</h1>
                <p className="text-sm">PARTNER WORKSHOP</p>
              </div>
            </div>
          </Link>
          ...
          <Link href={"#"}>
            <div className={styles.main_div}>
              ...
              <div className={styles.desc_div}>
                <h1 className={styles.box_heading_blue}>PakWheels</h1>
                <p className="text-sm">CAR REGISTRATION</p>
              </div>
            </div>
          </Link>
          ...
          <Link href={"#"}>
            <div className={styles.main_div}>
              ...
              <div className={styles.desc_div}>
                <h1 className={styles.box_heading_blue}>PakWheels</h1>
                <p className="text-sm">OWNERSHIP TRANSFER</p>
              </div>
            </div>
          </Link>
        </div>
